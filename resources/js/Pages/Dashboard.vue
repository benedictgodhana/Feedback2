    ...
    <AdminLayout :categories="categories" >
        <v-container fluid>
            <v-row>
                ...
                <v-col cols="12" md="6" lg="3">
                    <v-card class="pa-3" elevation="14" rounded>
                        <v-card-title style="background-color: darkblue; color:white">Total Categories</v-card-title>
                        <v-divider></v-divider>
                        <v-card-text style="font-size:18px;font-weight: 700;">{{ TotalCategories }}</v-card-text>
                        <v-btn width="100%" color="orange" style="text-transform: none;">View All Categories</v-btn>
                    </v-card>
                </v-col>

                <v-col cols="12" md="6" lg="3">
                    <v-card class="pa-3" elevation="14" rounded>
                        <v-card-title style="background-color: darkblue; color:white">Total SubCategories</v-card-title>
                        <v-divider></v-divider>
                        <v-card-text style="font-size:18px;font-weight: 700;">{{TotalSubCategories }}</v-card-text>
                        <v-btn width="100%" color="orange" style="text-transform: none;">View SubCategories</v-btn>
                    </v-card>
                </v-col>

                <v-col cols="12" md="6" lg="3">
                    <v-card class="pa-3" elevation="14" rounded>
                        <v-card-title style="background-color: darkblue; color:white">Total Roles</v-card-title>
                        <v-divider></v-divider>
                        <v-card-text style="font-size:18px;font-weight: 700;">{{ TotalRoles }}</v-card-text>
                        <v-btn width="100%" color="orange" style="text-transform: none;">View All Roles</v-btn>
                    </v-card>
                </v-col>
                <!-- Feedback Cards -->
                <v-col cols="12" md="6" lg="3">
